...
> 项目目前处于 Phase 0 领域骨架阶段。现已包含安全 Electron sidecar、项目与 UTF-8 TXT 摄取、不可变 Artifact/Gate 基础、类型化故事圣经后端，以及可核对逐事实精确引文的只读“来源 / 结构化正典 / 编剧审阅”故事工坊。AI 自动拆解、手工编辑、受信任 G1/G2 确认、分镜生成、Provider 与时间线仍在后续纵切中；界面不会把这些未开放能力伪装为可用。Aijian Studio 当前只是技术项目名称，最终产品品牌另行决策。
