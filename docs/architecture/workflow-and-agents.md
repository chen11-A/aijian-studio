...
节点状态最少包含 `PENDING/RUNNING/SUBMIT_INTENT/SUBMITTING/WAITING_REMOTE/REMOTE_UNKNOWN/RECONCILIATION_REQUIRED/NEEDS_REVIEW/SUCCEEDED/FAILED/CANCEL_REQUESTED/CANCELLED/SUPERSEDED`。队列只负责唤醒执行；数据库状态机决定什么可以运行。
